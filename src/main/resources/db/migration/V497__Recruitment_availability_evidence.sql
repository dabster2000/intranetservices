-- ===================================================================
-- V497: Recruitment ATS — Method B availability evidence + constraints
-- ===================================================================
...
--     is CHECK-pinned like V495; REJECTED rows (UNKNOWN intent, failed
...
--   (and re-apply V495's sp_sync_prod_to_staging to drop the two
...
--    Established pattern (V258, V453/V457, V466, V490, V495): the FULL
--    procedure body below is copied VERBATIM from V495 — the latest
--    declaration — with exactly one change: the two Method B evidence
--    tables appended to the TABLE_NAME NOT IN (...) list beside their
--    recruitment siblings, marked with a V497 comment.
--
--    They belong on the list for the same reason the V495 block does:
    ...
    DECLARE cur_tables CURSOR FOR
        ...
        WHERE TABLE_SCHEMA = 'twservices4'
          ...
          AND TABLE_NAME NOT IN (
              ...
              'recruitment_availability_evidence',   -- V497
              'recruitment_availability_constraint', -- V497
