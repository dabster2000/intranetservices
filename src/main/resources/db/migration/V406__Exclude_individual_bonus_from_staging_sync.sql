-- ====================================================================
-- V406: Keep Individual Bonus compensation workflow state out of the
--       prod->staging sync, alongside existing environment-specific tables.
--
-- Individual Bonus rules, snapshots, proofs, adjustments, and audit events
-- contain sensitive compensation data and staging-owned workflow state. Copying
-- them from production would expose unanonymized values and erase staging test
-- evidence. Body is V372 with only the exclusion list extended.
-- Rollback: re-apply V372's procedure body.
-- ====================================================================
