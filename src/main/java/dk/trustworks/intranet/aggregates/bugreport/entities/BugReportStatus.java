...
public enum BugReportStatus {
    ...
    public Set<BugReportStatus> allowedTransitions() {
        return switch (this) {
            ...
            case SUBMITTED -> Set.of(IN_PROGRESS, AUTO_FIX_REQUESTED, CLOSED);
            case IN_PROGRESS -> Set.of(AUTO_FIX_REQUESTED, RESOLVED, CLOSED);
            case AUTO_FIX_REQUESTED -> Set.of(IN_PROGRESS, SUBMITTED, CLOSED);
